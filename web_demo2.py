...
@st.cache_resource
def get_model():
    tokenizer = AutoTokenizer.from_pretrained("ChatGLM2-6B/ZhipuAI/chatglm2-6b", trust_remote_code=True)
    model = AutoModel.from_pretrained("ChatGLM2-6B/ZhipuAI/chatglm2-6b", trust_remote_code=True).cuda()
